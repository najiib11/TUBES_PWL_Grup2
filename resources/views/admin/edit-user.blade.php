            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg">
                <div class="py-10 text-gray-900 dark:text-gray-100 bg-gray-100 flex items-center justify-center">
                    <div class="bg-white px-10 py-10 rounded shadow-md w-full max-w-md">
                        <form id="profileForm" method="POST" action="{{route('admin.save', $id)}}">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="flex items-center justify-between">
                                <input type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" value="Simpan">
