                                    ...
                                    <form action="{{ route(substr(request()->route()->getPrefix(), 1, strlen(request()->route()->getPrefix()) - 1).'.profile.save') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="flex flex-col gap-10 items-center">
                                            <label for="name"> Nama Pengguna
                                                <br><input type="text" name="name" id="name" class="mb-14 px-[85px] shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                            @error("name")
